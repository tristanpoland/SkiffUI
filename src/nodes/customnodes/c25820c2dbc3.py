...
class DockerNode(api.Node):
    ...
    def NodeMeta(self):
        meta_info = {
            "label": "gracious_mayer",
            "author": "Gameplex Software",
            "version": (0, 0, 1),
            "category": "FILTER",
            "description": "Show gracious_mayer container in the 'Add Node' menu",
        }
        return meta_info
...
api.RegisterNode(DockerNode, "c25820c2dbc3")