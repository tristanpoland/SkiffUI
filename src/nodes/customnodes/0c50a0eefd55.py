...
class DockerNode(api.Node):
    ...
    def NodeMeta(self):
        meta_info = {
            "label": "optimistic_fermi",
            "author": "Gameplex Software",
            "version": (0, 0, 1),
            "category": "FILTER",
            "description": "Show optimistic_fermi container in the 'Add Node' menu",
        }
        return meta_info
...
api.RegisterNode(DockerNode, "0c50a0eefd55")