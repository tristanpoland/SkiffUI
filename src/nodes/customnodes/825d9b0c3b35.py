...
class DockerNode(api.Node):
    ...
    def NodeMeta(self):
        meta_info = {
            "label": "affectionate_goldstine",
            "author": "Gameplex Software",
            "version": (0, 0, 1),
            "category": "FILTER",
            "description": "Show affectionate_goldstine container in the 'Add Node' menu",
        }
        return meta_info
    ...
    def NodeInitProps(self):
        ...
        container_name = api.LabelProp(
            ...
            default="affectionate_goldstine",
            show_p=False
        )
...
api.RegisterNode(DockerNode, "825d9b0c3b35")