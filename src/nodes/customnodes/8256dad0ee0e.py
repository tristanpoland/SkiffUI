...
class DockerNode(api.Node):
    ...
    def NodeMeta(self):
        meta_info = {
            "label": "condescending_shamir",
            "author": "Gameplex Software",
            "version": (0, 0, 1),
            "category": "FILTER",
            "description": "Show condescending_shamir container in the 'Add Node' menu",
        }
        return meta_info
...
api.RegisterNode(DockerNode, "8256dad0ee0e")