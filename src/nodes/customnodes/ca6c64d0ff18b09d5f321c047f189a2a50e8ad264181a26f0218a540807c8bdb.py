...
class DockerNode(api.Node):
    ...
    def NodeMeta(self):
        meta_info = {
            "label": "<Image: 'factoriotools/factorio:latest'>",
            "author": "Gameplex Software",
            "version": (0, 0, 1),
            "category": "FILTER",
            "description": "Show <Image: 'factoriotools/factorio:latest'> image on the node graph",
        }
        return meta_info
    ...
    def NodeInitProps(self):
        image_id = api.LabelProp(
            idname="image_id",
            default="ca6c64d0ff18b09d5f321c047f189a2a50e8ad264181a26f0218a540807c8bdb"
        )
...
api.RegisterNode(DockerNode, "ca6c64d0ff18b09d5f321c047f189a2a50e8ad264181a26f0218a540807c8bdb")