...
class DockerNode(api.Node):
    ...
    def NodeMeta(self):
        meta_info = {
            "label": "suspicious_wescoff",
            "author": "Gameplex Software",
            "version": (0, 0, 1),
            "category": "FILTER",
            "description": "Show suspicious_wescoff container in the 'Add Node' menu",
        }
        return meta_info
...
api.RegisterNode(DockerNode, "d505e6eb6872")