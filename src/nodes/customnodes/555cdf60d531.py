...
class DockerNode(api.Node):
    ...
    def NodeMeta(self):
        meta_info = {
            "label": "agitated_tesla",
            "author": "Gameplex Software",
            "version": (0, 0, 1),
            "category": "FILTER",
            "description": "Show agitated_tesla container in the 'Add Node' menu",
        }
        return meta_info
...
api.RegisterNode(DockerNode, "555cdf60d531")