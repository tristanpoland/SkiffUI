...
class DockerNode(api.Node):
    ...
    def NodeMeta(self):
        meta_info = {
            "label": "cranky_dijkstra",
            "author": "Gameplex Software",
            "version": (0, 0, 1),
            "category": "FILTER",
            "description": "Show cranky_dijkstra container in the 'Add Node' menu",
        }
        return meta_info
...
api.RegisterNode(DockerNode, "23971a53f823")