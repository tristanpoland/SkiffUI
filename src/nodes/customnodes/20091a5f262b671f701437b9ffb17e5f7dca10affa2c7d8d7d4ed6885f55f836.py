...
class DockerNode(api.Node):
    ...
    def NodeMeta(self):
        meta_info = {
            "label": "<Image: 'maven:latest'>",
            "author": "Gameplex Software",
            "version": (0, 0, 1),
            "category": "FILTER",
            "description": "Show <Image: 'maven:latest'> image on the node graph",
        }
        return meta_info
    ...
    def NodeInitProps(self):
        image_id = api.LabelProp(
            idname="image_id",
            default="20091a5f262b671f701437b9ffb17e5f7dca10affa2c7d8d7d4ed6885f55f836",
            fpb_label="Image ID"
        )
...
api.RegisterNode(DockerNode, "20091a5f262b671f701437b9ffb17e5f7dca10affa2c7d8d7d4ed6885f55f836")